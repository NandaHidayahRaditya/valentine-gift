const CONFIG = {
    mainQuestion: "Do You Love Me Bb?",
    subQuestion: "Please say yes ",
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["eh ko gituu?😕", "bb? u dont love me? :(", "GA, U SHOULD LOVE ME ALWAYS BB 💕"],
    confirmTitle: "YEAAAY! I ALWAYS LOVE UU ECIH!",
    confirmText: "Sedikit Tebak Tebakan...",
    badgeText: "Apa yang tetap bersinar terang walaupun langit sedang gelap gulita?",
    nextButton: "Lanjut ",
    repeatButton: "Ulangi pertanyaan",
    flowerTitle: "'Ini aku waktu kecil, belum tahu apa-apa, tapi satu hal yang pasti aku pengen saat ini adalah selalu jadi seseorang yang bisa bikin kamu bahagia bb.'",
    takeBouquetButton: "CLICK!",
    bouquetMessage: "Kita Terus Sama Sama Ya 💕",
    nextFlowerButton: "Next ",
    collageTitle: "My Piece Of A Diamond",
    collageSubtitle: "Ini adalah wujud dari potongan berlian yang aku punya 💕",
    nextCollageButton: "Satu halaman lagi… ",
    finalTitle: "Happy Valentine, My Love 💞",
    finalMessage: `A lil bit letter from me, Terimakasih yaa esih sudah mau ngasih kesempatan buat aku ditengah keraguan kamu karena masalalu. Suatu Kesempatan yang sangat sangat berharga buat aku untuk kenal lebih jauh dengan kamu, terimakasih udah hadir dihidup aku yg ngebuat keseharianku jadi lebih berwarna dan lebih berkesan meskipun first impression i ke kamu ngga yang wah banget karena aku liat tu u orangnya kaya yang cuek banget tapi ternyata selama ini aku salah ternnyata u orangnya care banget dan baik sama siapapun. Terimakasih yaa bb udah mau baik sama semua orang bahkan disaat u cape pun kamu ngga egois, big hug for u bb🫂, btw aku punya lagu buat kamu, coba klik dulu tombol dibawah. oh ya bb kalau sewaktu waktu kamu merasa insecure sama orang lain dari hal apapun itu inget lagu ini ya, kamu yang terbaik dimata aku sebagaimana diri kamu bb. fun fact aku suka lagu just the way you are by bruno mars ini karena ini lagu menggambarkan kamu banget, everytime i play this song it reminds me of you bb💕. Maaf ya esih aku baru bisa kasih ini yang ngga seberapa, tapi aku usahain akan selalu kasih yg terbaik buat u yaa.`,
